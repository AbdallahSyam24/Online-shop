                        ...
                        cart.length === 0
                            ...
                            : <>
                                <div className='flex justify-end'>
                                    <button id="clearCart" className='text-[#3e77aa] hover:text-red-500 transition p-2 sm:p-3' onClick={() => clearCartBtn(cart)}>Delete All</button>
                                </div>
                                ...
                                <div className='flex justify-center pr-0 py-3 sm:py-4 sm:pr-6 sm:justify-end'>
                                    <div className='bg-gray-200 w-fit py-3 px-2 rounded-xl border border-gray-500 flex flex-col justify-between items-center sm:flex-row sm:py-6 sm:px-4'>
                                        <div className='mr-0 sm:mr-4'>
                                            ...
                                            <span id="totalAmount" className='text-base sm:text-xl'>{totalPrice()} $</span>
                                        </div>
                                        <button className='text-sm sm:text-lg uppercase bg-black text-white py-1 px-4 rounded hover:bg-gray-500 transition mt-1 sm:mt-0' onClick={() => navigate('/checkout')}>buy now</button>
                                    </div>
                                </div>
                            </>
                    }
